...
<%@ page import="org.mindrot.jbcrypt.BCrypt" %>  <!-- Importamos jBCrypt para la comparación de contraseñas encriptadas -->
<%@ page contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%>
<%
    String correo = request.getParameter("correo");
    String contrasena = request.getParameter("contrasena");  // Contraseña ingresada por el usuario
    ...
    try {
        ...
        // Consultar si el usuario con el correo existe
        ...
        if (rs.next()) {
            ...
            // Verificar si la contraseña almacenada está encriptada con bcrypt (comienza con $2a$, $2b$, o $2y$)
